...
4.  **Model MIDASR A:** wykorzysta model [**midasr**](https://cran.r-project.org/web/packages/midasr/index.html) oraz **cen zamknięcia** akcji wraz z danymi makroekonomicznymi (kilka wymiarów, kilka częstotliwości).
5.  **Model MIDASR B:** wykorzysta model [**midasr**](https://cran.r-project.org/web/packages/midasr/index.html) oraz **pełnych informacji giełdowych** wraz z danymi makroekonomicznymi (kilka wymiarów, kilka częstotliwości).
